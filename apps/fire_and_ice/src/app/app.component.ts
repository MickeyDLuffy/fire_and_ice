...
export class AppComponent {
  ...
  constructor(
    ...
    this.bookService
      .findOne('https://www.anapioficeandfire.com/api/books/1')
      .subscribe((a) => console.log(a, 'findone'));
    this.bookService.findAll().subscribe((a) => console.log(a, '2332323'));
    this.bookService.findAll().subscribe((a) => console.log(a, '2332323'));
    this.bookService
      .findAll({ page: '1', pageSize: '20' })
      .subscribe((a) => console.log(a, '2332323'));
    this.bookService.findAll().subscribe((a) => console.log(a, '2332323'));
    this.bookService.findAll().subscribe((a) => console.log(a, '2332323'));
    this.bookService
      .findAll(undefined, { name: 'A Clash of Kings' })
      .subscribe((a) => console.log(a, '2332323'));
    this.bookService.findAll().subscribe((a) => console.log(a, '2332323'));
